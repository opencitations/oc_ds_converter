...
class orcidIdentifierManagerTest(unittest.TestCase):
    ...
    def test_exists(self):
        with self.subTest(msg="get_extra_info=True, allow_extra_api=None"):
            ...
            expected_output = (True, {'id': '0000-0001-5506-523X', 'valid': True, 'family_name': 'Shotton', 'given_name': 'David', 'email': "", 'external_identifiers': {}, 'submission_date': '2012-10-31', 'update_date': '2023-09-02'})
