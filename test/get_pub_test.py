...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_pub_API_crossref(self):
        ...
        pub_1016 = e_p_doi.extract_publishers_v("10.1016/0005-2728(75)90129-2")
        pub_1136 = e_p_doi.extract_publishers_v("10.1136/bmj.4.5994.440")
        pub_1021 = e_p_doi.extract_publishers_v("10.1021/bi00695a008")
        pub_1007 = e_p_doi.extract_publishers_v("10.1007/bmj.4.5994.440")
        pub_1097 = e_p_doi.extract_publishers_v("10.1097/00003246-197507000-00003")
        pub_1378 = e_p_doi.extract_publishers_v("10.1378/chest.68.6.814")
        pub_1055 = e_p_doi.extract_publishers_v("10.1055/s-0028-1106478")
        pub_1080 = e_p_doi.extract_publishers_v("10.1080/0743580750908416")
        pub_1210 = e_p_doi.extract_publishers_v("10.1210/endo-97-4-855")
        pub_1159 = e_p_doi.extract_publishers_v("10.1159/000458949")
    ...
    def test_get_pref_info_from_dict(self):
        ...
        pub_d = e_p_doi_2.extract_publishers_v(dataicte_doi)
        pub_c = e_p_doi_1.extract_publishers_v(crossref_doi)
    ...
    def test_get_pub_API_medra(self):
        ...
        pub_m = e_p_doi_4.extract_publishers_v(medra_doi)
        pub_m2 = e_p_doi_4.extract_publishers_v(medra_doi_no_pub)
